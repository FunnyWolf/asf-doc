...
- ~~Agents 基础智能体框架~~（已废弃，已由 [ClaudeCode 插件](../../asp/integrations/claude-code/) 的 Agent 体系替代）
- ~~Qdrant 向量数据库插件~~（已废弃）
- ~~Embeddings 插件~~（已废弃）
- [Knowledge](../../asp/workspace/knowledge/) 知识库，支持知识库管理及 Agent 的知识库调用。
- ~~Case_L3_SOC_Analyst_Agent_With_Tools 剧本~~（已废弃，已由 [Playbook](../../asp/development/playbook/) 体系替代）
