...
- [Neo4j](../../asf/PLUGINS/Neo4j/) Neo4j 图数据库插件, 用于支持 Mem0 插件的知识图谱存储.
- [Mem0](../../asf/PLUGINS/Mem0/) Mem0 插件, 支持 Mem0 管理知识库, 为知识库和智能体提供图数据库支持 (Beta).
- [Embeddings](../../asf/PLUGINS/Embeddings/) Embeddings 插件, 支持 OpenAI 和 Ollama 的 Embedding 模型, 支持Chroma 和 Qdrant 两种向量数据库.
- [Knowledge](../../sirp/Feature/knowledge/) 知识库 和 [Knowledge](../../asf/AGENTS/Knowledge/) 智能体, 支持知识库管理及 Agent 的知识库调用.
