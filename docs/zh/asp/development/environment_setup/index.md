...
- **[Redis Plugin - 部署](../../integrations/RedisStack/index.md)**
...
- **Redis**: 连接信息 — [配置方法](../../integrations/RedisStack/index.md)
- **LLM**: API 凭据和地址 — [配置方法](../../integrations/LLM/index.md)
- **SIRP**: 连接信息 — [配置方法](../../integrations/SIRP/index.md)
- **AlienVaultOTX**: 凭据 — [配置方法](../../integrations/AlienVaultOTX/index.md)
